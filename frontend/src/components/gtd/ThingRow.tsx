...
import type { Thing, Project, ItemEditableFields } from "@/model/gtd-types";
    ...
    <div className={className}>
      ...
      >
        ...
        <button
          ...
          aria-label={
            isCompleted
              ? `Completed: ${thing.title}`
              : `Complete ${thing.title}`
          }
          className={cn(
            "shrink-0",
            isCompleted
        ...
        <button
          ...
          aria-label={
            thing.isFocused ? `Unfocus ${thing.title}` : `Focus ${thing.title}`
          }
          className={cn(
            "shrink-0",
            thing.isFocused
        ...
        {thing.notes && (
          <button
            ...
            aria-label={`Show notes for ${thing.title}`}
