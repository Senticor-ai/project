...
| `OTEL_EXPORTER_OTLP_ENDPOINT` | `http://alloy-otlp.observability.svc.cluster.local:4318`      |
...
For read-only incident access through MCP clients, see [Grafana MCP for Project](?path=/docs/engineering-grafana-mcp-for-project--docs).
