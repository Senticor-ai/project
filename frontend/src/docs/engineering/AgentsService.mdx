...
project supports two agent backends that share the same chat UI and backend APIs but are
...
| `OPENROUTER_APP_TITLE` | `project` | Sent as `X-Title` header to OpenRouter |
