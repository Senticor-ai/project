...
<Meta title="Engineering/Schema Reference" />

# Schema.org Reference

This document defines the schema.org entities used in the Todo app. The app spans personal work, business work, and procedural work. Data is stored as JSON-LD and aligned to schema.org vocabulary for interoperability and semantic clarity.
