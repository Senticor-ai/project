...
| Store | Purpose |
| --- | --- |
| **PostgreSQL** | Immutable catalog (Things + Assertions, JSON-LD) — source of truth |
...
- [Data Model](?path=/docs/engineering-ontology--docs) — Schema.org-first data model (GTD entities, properties, JSON-LD)
