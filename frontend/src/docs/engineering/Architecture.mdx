...
System(tay, "Senticor Project", "Structured task management with AI-assisted triage, Schema.org data model, append-only audit trail")
...
System_Boundary(tay, "Senticor Project") {
