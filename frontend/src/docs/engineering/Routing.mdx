...
| `/workspace/next` | Workspace | Next Actions bucket |
| `/workspace/project` | Workspace | Projects bucket |
| `/workspace/waiting` | Workspace | Waiting For bucket |
| `/workspace/calendar` | Workspace | Calendar bucket |
| `/workspace/someday` | Workspace | Someday/Maybe bucket |
...
1. The URL stays at `/settings/labels`
