...
TerminAndoYo is built using **Storybook as the single source of truth** for the entire
...
| Document                                                                                | Purpose                                 |
| --------------------------------------------------------------------------------------- | --------------------------------------- |
| [Product Vision](?path=/docs/product-product-vision--docs)                              | Core workflow, buckets, principles, Tay |
...
| Epics (Tay Copilot, PWA, Export, Release, Schema Enrichment, Editable Title, Rename...) | Detailed feature specifications         |
...
TerminAndoYo is built by a human-AI pair: one product owner/developer working with
...
6. **Docs are updated** — When architecture changes, new features land, or gotchas
   are discovered, the MDX docs are updated in the same session. Knowledge stays
