...
Upload a job description, let Tay analyse it against your CV, create a tailored markdown version you can review and edit, then render a professional PDF — all within TerminAndoYo.
