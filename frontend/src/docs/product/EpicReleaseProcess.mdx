...
crane ls harbor.100-114-108-51.nip.io:30443/project/frontend --insecure  # shows both SHA and v0.1.0
...
push-frontend:
  ...
  script:
    - crane push /tmp/frontend.tar "${HARBOR_REGISTRY}/project/frontend:${CI_COMMIT_SHORT_SHA}" --insecure
```
