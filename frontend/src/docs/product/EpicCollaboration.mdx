...
**Checklist audit:** February 23, 2026 — checked items reflect implemented backend/API slices; remaining work stays unchecked.
**Priority:** Current
...
- [ ] Board and list views scopilot consistent via shared `actionStatus` source.
