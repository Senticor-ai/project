...
## What's next (backend — V1 scope)

- [ ] `POST /chat/completions` — single-message proxy → Haystack agent → OpenRouter
- [ ] 3 tool definitions matching frontend tool types (`create_project_with_actions`, `create_action`, `create_reference`)
- [ ] German system prompt
- [ ] Graceful error handling (503/502 from OpenRouter → user-friendly error message)
