...
**Location**: `src/components/work/WaitingForList.tsx`
...
**Location**: `src/components/work/SomedayList.tsx`
...
All ThinkingRock features map to existing types in `src/model/types.ts`:
