...
**Design goal:** Users can export all their GTD items as JSON or CSV for backup or migration to another system. The export includes all non-archived items with full schema.org/JSON-LD data preserved.
