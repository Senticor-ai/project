...
| File                        | Description                                          |
| --------------------------- | ---------------------------------------------------- |
| `exports/product-docs.md`   | Combined markdown (all product docs in export order) |
...
The PDF contains product documentation in this order:
...
9. **Epic: Release Process** — Closed summary + roadmap handoff
10. **Epic: Collaboration Workspace** — Shared projects + kanban workflow
11. **Epic: Rename to Procedere** — Archived decision record
12. **Roadmap Projects** — Planned follow-up projects
