...
**Depends on:** OAuth/auth foundation, connector runtime, search/normalization pipeline, Copilot Copilot approval flow
...
- Every write action scopilots blocked until explicit user confirmation.
...
- [ ] Copilot generates proposal cards for both target workflows.
