...
# Export derived URLs
export VITE_API_BASE_URL="http://localhost:$DEV_BACKEND_PORT"
export AGENTS_URL="http://localhost:$DEV_AGENTS_PORT"
export BACKEND_URL="http://localhost:$DEV_BACKEND_PORT"
export CORS_ORIGINS="http://localhost:$DEV_FRONTEND_PORT,http://localhost:$DEV_STORYBOOK_PORT"
export FRONTEND_BASE_URL="http://localhost:$DEV_FRONTEND_PORT"
export OPENROUTER_APP_URL="http://localhost:$DEV_FRONTEND_PORT"

echo "[dev] PORT_OFFSET=$PORT_OFFSET"
echo "[dev]   Frontend:  :$DEV_FRONTEND_PORT"
echo "[dev]   Backend:   :$DEV_BACKEND_PORT"
echo "[dev]   Agents:    :$DEV_AGENTS_PORT"
echo "[dev]   Storybook: :$DEV_STORYBOOK_PORT"
echo ""
