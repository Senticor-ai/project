...
Copied from agents/jsonld_builders.py for the OpenClaw path where
tool execution happens directly in the backend (no agents round-trip).
"""
...
def build_project_jsonld(
    ...
    """Build JSON-LD for a Project item."""
...
def build_action_jsonld(
    ...
    """Build JSON-LD for an Action item."""
...
def build_reference_jsonld(
    ...
    """Build JSON-LD for a CreativeWork reference."""
