...
def auth_headers(client):
    """Fixture to get authentication headers for protected endpoints."""
    ...
    # Return cookies from login response
    return {"Cookie": f"project_session={login_response.cookies.get('project_session')}"}


def test_file_size_validation_exceeds_limit(auth_headers):
    """
...
def test_file_size_validation_within_limit(auth_headers):
    """
...
def test_file_type_validation_disallowed_exe(auth_headers):
    """
...
def test_file_type_validation_disallowed_zip(auth_headers):
    """
...
def test_file_type_validation_allowed_pdf(auth_headers):
    """
...
def test_file_type_validation_allowed_jpeg(auth_headers):
    """
...
def test_file_type_validation_allowed_docx(auth_headers):
    """
...
def test_combined_validation_oversized_disallowed_type(auth_headers):
    """
